...
class BridgeMappingResolverTest {
    ...
    void mapsAndUnmapsTinyV2ClassesFieldsAndMethods() throws Exception {
        ...
        assertThat(resolver.getNamespaces()).containsExactly("intermediary", "official");
        assertThat(resolver.getCurrentRuntimeNamespace()).isEqualTo("official");
        ...
        assertThat(resolver.mapClassName("official", "example.Unmapped"))
    ...
    void rejectsInvalidNamespaceClassFormatAndMappingHeader() throws Exception {
        ...
        assertThatIllegalArgumentException()
                .isThrownBy(() -> resolver.mapClassName("official", "example/Class"));
    ...
    @Test
    void readsLegacyPreparedMappingsWithoutAdvertisingTheInternalNamedLabel() throws Exception {
        Path mappings = temporaryDirectory.resolve("legacy.tiny");
        ...
        assertThat(resolver.mapClassName("intermediary", "net.minecraft.class_310"))
                .isEqualTo("net.minecraft.client.Minecraft");
        assertThatIllegalArgumentException()
                .isThrownBy(() -> resolver.mapClassName("named", "net.minecraft.client.Minecraft"));
    }
