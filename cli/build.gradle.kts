...
dependencies {
    ...
    runtimeOnly(project(":fabric-events-interaction-v0-bridge")) {
        isTransitive = false
    }
    ...
    runtimeOnly(project(":fabric-screen-handler-api-v1-bridge")) {
        isTransitive = false
    }
    ...
    runtimeOnly(project(":fabric-block-api-v1-bridge")) {
        isTransitive = false
    }
    runtimeOnly(project(":fabric-item-api-v1-bridge")) {
        isTransitive = false
    }
