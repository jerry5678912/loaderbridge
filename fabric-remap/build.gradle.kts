...
dependencies {
    ...
    testRuntimeOnly(project(":fabric-tag-api-v1-bridge")) {
        isTransitive = false
    }
    testRuntimeOnly(project(":fabric-dimensions-v1-bridge")) {
        isTransitive = false
    }
    testRuntimeOnly(project(":fabric-message-api-v1-bridge")) {
        isTransitive = false
    }
    testRuntimeOnly(project(":fabric-crash-report-info-v1-bridge")) {
        isTransitive = false
    }
    testRuntimeOnly(project(":dimensions-datafix-agent")) {
        isTransitive = false
    }
    testRuntimeOnly(project(":dimensions-datafix-agent-provider")) {
        isTransitive = false
    }
